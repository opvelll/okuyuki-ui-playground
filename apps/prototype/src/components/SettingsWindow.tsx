...
const prototypeSettingsMenuItems = settingsMenuItems.filter(
  (menuItem) => menuItem.key !== "modeling-ui",
);
    ...
    <div className={overlayClasses}>
      ...
      >
        ...
        <div className="grid min-h-0 flex-1 gap-3 overflow-y-auto px-3 pb-3 pt-3 md:grid-cols-[8.5rem_minmax(0,1fr)] md:px-4 md:pb-4">
          ...
          >
            {prototypeSettingsMenuItems.map((menuItem) => {
