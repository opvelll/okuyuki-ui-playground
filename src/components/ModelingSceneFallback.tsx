export function ModelingSceneFallback() {
  return (
    <div
      ...
      className="flex h-[calc(100vh-8rem)] min-h-[26.25rem] items-center justify-center overflow-hidden border border-white/12 bg-[radial-gradient(circle_at_top,rgba(148,163,184,0.2),transparent_28%),linear-gradient(180deg,#0b1220_0%,#111827_50%,#172033_100%)] shadow-[0_18px_40px_rgba(3,10,20,0.22)]"
    >
